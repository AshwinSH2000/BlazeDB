...
public class SelectionOperator extends Operator {
	 ...
	 * 
	 * @param whereCondition This is an Expression that has one or many WHERE
	 * clauses joined by AND clause
	 * 
	...
	/*
	 * This method scans each tuple passed by its child operator and evaluates it
	 * against all the WHERE clause passed. If it satisfies all the
	 * conditions/clause then it is returned back to be used for further operations
	 * or to be printed to file.
	 * 
	 * @return tuple The tuple which satisfies the conditions specified in the SQL
	 * query
	 */
	@Override
