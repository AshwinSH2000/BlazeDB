...
public class ScanOperator extends Operator {
	...
	/*
	 * This is the constructor of this class. Apart from initializing the class
	 * variables, it also creates a HashMap. The HashMap contains a mapping from the
	 * columnNames of the table to an integer value representing the column's
	 * position in the table for example, Student.A=0, Student.B=1, Student.C=2 and
	 * so on
	 * 
	 ...
	 * 
	 * @return (list<String>) returns a list of strings that contain schema of the
	 * table
	 */
	...
	/*
	 * Method that opens the file containing data about the table. It uses the
	 * filePath argument to open the table to read its data
	 */
	...
	/*
	 * Method to read the opened file line by line and store the data in a list of
	 * strings. It then parses these strings to store the data in a tuple (which is
	 * a list of integers)
	 * 
	 ...
	 * from the very beginning. Closing and reopening the file sets it to read it
	 * from the beginning
	 */
	@Override
	public void reset() {
