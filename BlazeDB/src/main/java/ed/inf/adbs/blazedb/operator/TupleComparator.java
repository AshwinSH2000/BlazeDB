...
public class TupleComparator implements Comparator<Tuple> {
	 ...
	 * 
	 * @param attributeHashIndex It is a HashMap that maps table attributes to
	 * integers representing the attribute's position in the table
	 */
	...
	/*
	 * Method used to compare the two passed tuples. It returns 0 if both tuples are
	 * equal, 1 if 1st tuple is greater, and -1 if 1st tuple is smaller.
	 * 
