...
public class EvaluateSelection extends ExpressionDeParser {
	 ...
	 * 
	 * @param attributeHashIndex The HashMap that contains a mapping from
	 * columnNames to the integer representing column's position in the tuple
	 * 
	...
	/*
	 * Method to split the main WHERE clause around AND keyword. It works
	 * recursively in case there are more than two AND keywords
	 * 
	...
	/*
	 * Method to evaluate the binary expression based on the operator present in the
	 * expression and store it in result
	 * 
	...
	/*
	 * Method that gets called when the left or right operand is of the type of a
	 * column reference. Its value need to be extracted.
	 * 
	 * @param column The column whose integer value needs to be extracted and stored
	 * in currentValue variable.
	 */
	@Override
	 ...
	 * Long number.
	 * 
	 * @param column The column whose value needs to be stored in currentValue
	 * variable.
	 */
	@Override
	...
	/*
	 * Method to begin the parsing of the WHERE clause. From this method it jumps to
	 * various 'visit' method based on the expression.
	 * 
